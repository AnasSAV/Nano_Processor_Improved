...
set_property PACKAGE_PIN W3 [get_ports {A_less_than_B}]
	set_property IOSTANDARD LVCMOS33 [get_ports {A_less_than_B}]
set_property PACKAGE_PIN U3 [get_ports {A_equal_B}]
	set_property IOSTANDARD LVCMOS33 [get_ports {A_equal_B}]
set_property PACKAGE_PIN P3 [get_ports {A_greater_than_B}]
	set_property IOSTANDARD LVCMOS33 [get_ports {A_greater_than_B}]
set_property PACKAGE_PIN N3 [get_ports {Overflow_mul}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Overflow_mul}]
set_property PACKAGE_PIN P1 [get_ports {Zero}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Zero}]
set_property PACKAGE_PIN L1 [get_ports {Overflow_add}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Overflow_add}]
